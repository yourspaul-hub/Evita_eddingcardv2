...
function GoldDivider() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "16px 0" }}>
      <div style={{ flex: 1, height: 1, background: "linear-gradient(to right, transparent, #C8A951)" }} />
      <span style={{ color: "#C8A951", fontSize: 10 }}>*</span>
      <div style={{ flex: 1, height: 1, background: "linear-gradient(to left, transparent, #C8A951)" }} />
    </div>
  );
}
...
const inputStyle: React.CSSProperties = {
  ...
  border: "1px solid #C8A95155", background: "#FFFDF9",
  color: "#4A1E2B", fontSize: 14, fontFamily: "Georgia, serif",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const body = {
        ...
        subject: "New RSVP - " + formData.name + " (" + formData.guests + " guest" + (formData.guests === "1" ? "" : "s") + ")",
        from_name: "Evita & Roshan Wedding",
        Name: formData.name,
        Phone: formData.phone || "N/A",
        "Number of Guests": formData.guests,
        "Accommodation Needed": formData.accommodation === "yes" ? "Yes - needs hotel help" : "No - sorted",
  ...
  return (
    <section className="py-20 px-6" style={{ background: CREAM }}>
      <div className="max-w-xl mx-auto">
                  ...
                  >
                    ...
                    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                          ...
                          {formData.accommodation === "yes" && (
                            ...
                            >
                              <div style={{
                                ...
                                border: "1px solid #C8A95144", background: "#C8A9510A",
                      ...
                      <button
                        ...
                        style={{
                          background: isSubmitting ? "rgba(74,30,43,0.5)" : BURGUNDY,
                          color: GOLD, border: "none", borderRadius: 3,
                          padding: "13px 0", fontSize: 11, letterSpacing: "0.2em",
        ...
        <PremiumBotanicalBorder style={{ marginTop: 20 }} />
      </div>
    </section>
  );
}
